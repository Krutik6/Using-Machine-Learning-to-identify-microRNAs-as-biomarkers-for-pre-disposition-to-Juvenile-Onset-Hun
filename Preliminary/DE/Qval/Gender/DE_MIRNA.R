#miRNA - gender matched genotype contrasts
...
miRNA <- read.csv("../../counts/miRNA_counts.csv", row.names = 1)
colnames(miRNA)
Pheno <- read.csv("../../counts/miRNA_Pheno.csv", row.names = 1)
...
write.csv(DF, "miRNA_qval_gender.csv")
