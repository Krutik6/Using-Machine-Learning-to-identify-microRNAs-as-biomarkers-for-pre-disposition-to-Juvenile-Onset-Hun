...
D_data <- D_data[,-c(63, 96, 127, 145, 157)]
...
X <- D_data[!rowSums(D_data < 50) >= 37, , drop = FALSE]
...
write.table(normalized_counts, file="normalized_miRNA_Nooutliers.txt", sep="\t", quote=F, col.names=NA)
###
...
setwd("~/Documents/HD/Data/miRNA/DE/NoBatch/MF")
